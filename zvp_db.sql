...
CREATE TABLE public."Students" (
    ...
    student_university_group character varying(10),
    student_faculty character varying(15),
...
COPY public."Teachers" (id, teacher_full_name, teacher_check_tests, teacher_department_id, teacher_rank_id, user_id) FROM stdin;
\.
...
1	pbkdf2_sha256$120000$8bAFtLtoBe6P$ZpFDUdqbzaywynL/SJSGnc+2m1F4lEJp/6+PsqHyHIw=	2019-04-03 21:24:56.686313+03	t	admin				t	t	2019-04-03 21:24:26.510735+03
\.
...
SELECT pg_catalog.setval('public."Troops_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public.control_panel_presence_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.django_admin_log_id_seq', 822, true);
...
SELECT pg_catalog.setval('public.quiz_app_startingquiz_id_seq', 1, false);
...
--
-- Name: Teachers Teachers_user_id_key; Type: CONSTRAINT; Schema: public; Owner: zvp_user
--
...
--
-- Name: Teachers Teachers_user_id_c125ca55_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: zvp_user
--

ALTER TABLE ONLY public."Teachers"
    ADD CONSTRAINT "Teachers_user_id_c125ca55_fk_auth_user_id" FOREIGN KEY (user_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
